...
enum class boardConstants : char { TABLE_MAX_HEIGHT = 25, TABLE_MAX_WIDTH = 80, LEGEND = '&', LEGEND_MAX_HEIGHT = 3, LEGEND_MAX_WIDTH = 25, 
	BLANK = ' ', WALL = 'W', WALL_COLOR = 1, BLOCK = '*', EXIT = 'E', EXIT_COLOR = 11 };
...
public:
	...
	bool isExit(int x, int y) const { return (_table[y][x] == static_cast<char>(boardConstants::EXIT)); }
};